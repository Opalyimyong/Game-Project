...
- ผู้เล่นเริ่มเกมด้วยเงินเริ่มต้น **750 coins**
...
3. เลือก Map และ Difficulty
4. กดปุ่ม `INITIALIZE MISSION`
5. เกมจะเข้าสู่หน้า `gameplay.html`
6. เริ่มเล่นตามลำดับเทิร์นของผู้เล่น
